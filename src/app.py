...
activities = {
    "Basketball Team": {
        ...
        "Art Studio": {
        "description": "Explore painting, sculpture, and various artistic mediums",
        ...
        "max_participants": 14,
        "participants": ["andrew@mergington.edu", "sophia@mergington.edu"]
        },
        "Robotics Club": {
        "description": "Build and program robots to compete in regional competitions",
        "schedule": "Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["chris@mergington.edu", "lisa@mergington.edu"]
        },
    "Chess Club": {
